...
//            softImpact.impactOccurred(intensity: 0.75)
        ...
        .onChange(of: prismSessionManager.masterEffect) { oldValue, newValue in
            ...
            prismSessionManager.updateMasterEffect(update: prismSessionManager.masterEffect)
        }
        .onChange(of: selectedTile) { oldValue, newValue in
            ...
            prismSessionManager.customColor = CGColor(red: selectedTile.red, green: selectedTile.green, blue: selectedTile.blue, alpha: 1)
        }
    }
}
