            ...
            ZStack {
                    ...
                    || prismSessionManager.currentMode == .themeParkMode
                {
                    ...
                    let endColor: Color = Color(
                        cgColor: prismSessionManager.tempClockColor
                    )
                    ...
                    .ignoresSafeArea()
                } else if prismSessionManager.currentLightEffect == .custom_m
                    && prismSessionManager.masterEffect != .onlyShowW
                {
                    let startColor: Color =
                        colorScheme == .dark ? .black : .white
                    let endColor: Color = Color(
                        cgColor: prismSessionManager.customColor
                    )
                ...
                VStack {
                        ...
                        || debug.testingSoDontShowSetup == true
                    {
                        ...
                        if prismSessionManager.currentMode == .sleepMode {  // show sleep options.
                            SleepModeView()
                        } else if prismSessionManager.currentMode == .home
                        ...
                        {  // show teleport options.
                            ...
                            Button(
                                ...
                                action: {
                                    ...
                                    prismSessionManager.sendCommand(
                                        command: .home
                                    )
                                }
                            )
                            ...
                            == .themeParkMode && !prismSessionManager.pending
                        {  // show theme park options.
                            ThemeParkView()
    ...
    struct TopTitleBar: View {
        ...
        var body: some View {
            HStack {
                ...
                if aiIsEnabled && !prismSessionManager.pending
                    && prismSessionManager.currentMode == .home
                {
