...
struct ContentView: View {
    ...
    var body: some View {
        ...
        if prismSessionManager.pickerDismissed && prismSessionManager.authenticated, let _ = prismSessionManager.prismboxVersion {
    ...
    private var makeSetupView: some View {
        VStack {
            ...
            Text("No PrismBox")
                ...
                .padding(.vertical, 12)
            Text("Make Sure Clock is Connected to Internet, Then Hold iPhone Near Clock and Proceed With Setup")
                .font(.subheadline)
