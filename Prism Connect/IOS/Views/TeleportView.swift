...
struct TeleportButton: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $telePicker) {
            ...
            Text(prismSessionManager.cityIsSelected ? prismSessionManager.selectedTeleportCity.nameForPicker() :          prismSessionManager.selectedPark.pickerName())
                .bold()
                .padding()
...
//                Rectangle()
//                    .frame(width: 2000, height: 5, alignment: .center)
