        ...
        var body: some View {
            RealityView { content in
                ...
                weatherManager = WeatherManager(
                    scene: Scene,
                    weather: prismSessionManager.clock_weather,
                    hour: prismSessionManager.clock_time_hour,
                    min: prismSessionManager.clock_time_min,
                    wholeRoom: prismSessionManager.wholeRoom
                )
            ...
            .onChange(of: prismSessionManager.clock_time_min) {
                weatherManager.updateTime(
                    hour: String(prismSessionManager.clock_time_hour),
                    min: String(prismSessionManager.clock_time_min)
                )
            }
        }
    }
